...
<ul>
	...
	<li>150g butter</li>
	<li>12 small shallots (350g in total), thinly sliced</li>
	<li>8 fresh red chillies (fairly mild ones), thinly sliced</li>
	<li>12 garlic cloves, crushed</li>
	<li>3 tbsp chopped fresh root ginger</li>
	<li>3 tbsp sweet soy sauce (kecap manis)</li>
	<li>3 tbsp light soy sauce</li>
	<li>4 tsp dark soy sauce</li>
	<li>2 tbsp caster sugar</li>
	<li>5 tbsp coarsely crushed black peppercorns (use a pestle and mortar or a spice grinder)</li>
	<li>16 small and thin spring onions, cut into 3cm segments</li>
</ul>
<h2>Method</h2>
...
<p>Add the tofu to warm it up in the sauce for about a minute. Finally, stir in the spring onions. Serve hot, with steamed rice.</p>

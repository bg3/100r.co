_header(.:Lazy bread:.)m4_dnl
<figure><img src="../media/img/codex/bread.jpg" class="wide"></figure>
<h2>Ingredients</h2>
<ul>
	<li>3 cups flour</li>
	<li>1 &half; cups warm water</li>
	<li>1 &frac34; tsp salt</li>
	<li>&half; tsp active dry yeast</li>
</ul>
<h2>Method</h2>
<p>Mix all ingredients in a large bowl and cover. You can add seeds, herbs and other ingredients as well.</p>
<p>Rest for 12-18 hours.</p>
<p>Preheat oven to 230&deg;C, with Dutch oven inside.</p>
<p>Remove from bowl, shape into boule. Score top.</p>

...
<nav></nav>
<main>
m4_ifdef(.:is_index:.,,_h1($1)):.)m4_dnl
m4_define(.:_footer:.,.:</main>
m4_ifdef(.:is_index:.,.:<a href="http://webring.xxiivv.com/"><img src="/media/img/ui/rotonde.svg" style="margin-top: 6em; width:30 !important;"></a>:.)m4_dnl
</body>
</html>:.)m4_dnl
